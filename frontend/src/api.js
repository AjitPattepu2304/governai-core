...
export const authApi = {
  ...
  login: (credentials) => request('/auth/login', { method: 'POST', credentials: 'include', body: JSON.stringify(credentials) }),
  register: (account) => request('/auth/register', { method: 'POST', credentials: 'include', body: JSON.stringify(account) }),
